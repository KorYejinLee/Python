...
red_df = pd.read_csv('D:/Code/python/wine_data/winequality-red.csv', sep = ';', header = 0, engine = 'python')
white_df = pd.read_csv('D:/Code/python/wine_data/winequality-white.csv',  sep = ';', header = 0, engine = 'python')

red_df.to_csv('D:/Code/python/wine_data/winequality-red2.csv', index = False)
white_df.to_csv('D:/Code/python/wine_data/winequality-white2.csv', index = False)
...
wine.shape
wine.to_csv('D:/Code/python/wine_data/wine.csv', index=False)
