...
titanic.to_csv('D:/Code/python/titanic_data/titanic.csv', index = False)
...
titanic_corr.to_csv('D:/Code/python/titanic_data/titanic_corr.csv', index = False)
...
titanic.to_csv('D:/Code/python/titanic_data/titanic3.csv', index = False)
